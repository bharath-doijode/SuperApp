...
const renderUpcoming = ({item}: any) => (
  <Card mode="contained">
    ...
    <Card.Actions>
      ...
      <Button mode="contained" style={{ borderRadius: 1 }}  theme={{ colors: { primary: 'brown' } }} onPress={showNotImplementedAlert}>
        Edit
      </Button>
    </Card.Actions>
  </Card>
...
const renderProduct: ListRenderItem<any> = ({item, index}) => (
  <Card mode="contained" style={styles.cardWidth}>
    ...
    <Card.Actions>
      <Button style={{ borderRadius: 1 }}  theme={{ colors: { primary: 'brown' } }} onPress={showNotImplementedAlert}> Delete</Button>
      <Button style={{ borderRadius: 1 }}  theme={{ colors: { primary: 'brown' } }} onPress={showNotImplementedAlert}>Edit</Button>
    </Card.Actions>
  </Card>
);
...
const renderArticle: ListRenderItem<any> = ({item, index}) => (
  <Card mode="contained" style={styles.cardWidth}>
    ...
    <Card.Actions>
      <Button onPress={showNotImplementedAlert} style={{ borderRadius: 1 }}  theme={{ colors: { primary: 'brown' } }}>Delete</Button>
      <Button onPress={showNotImplementedAlert} style={{ borderRadius: 1 }}  theme={{ colors: { primary: 'brown' } }}>Edit</Button>
    </Card.Actions>
  </Card>
);

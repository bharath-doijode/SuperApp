...
const renderProduct: ListRenderItem<any> = ({item, index}) => (
  <Card mode="contained" style={styles.cardWidth}>
    ...
    <Card.Actions>
      <Button onPress={showNotImplementedAlert} style={{ borderRadius: 1 }}  theme={{ colors: { primary: 'brown' } }}>To Wishlist</Button>
      <Button onPress={showNotImplementedAlert} style={{ borderRadius: 1 }}  theme={{ colors: { primary: 'brown' } }}>Buy</Button>
    </Card.Actions>
  </Card>
);
